...
- Event examples: `SLACK_TASK_INTAKE`, `TASK_CREATED`, `MODEL_INFERRED`, `POLICY_CHECKED`, `APPROVAL_REQUESTED`, `APPROVAL_BLOCKED`, `APPROVAL_BYPASSED`, `HUMAN_APPROVED`, `CHAT_QUICK_ACTION_USED`, `ACTION_SKIPPED`, `ACTION_EXECUTED`, `ACTION_FAILED`, `INCIDENT_DECLARED`, `GOVERNANCE_RECOMMENDATION_APPLIED`, `GOVERNANCE_RECOMMENDATIONS_REVIEWED`, `GOVERNANCE_RECOMMENDATIONS_REVIEW_FAILED`.
